...
from app.pkg.models.base import BaseException, Model
...
def response_with_error(
    ...
    def check(
        ...
        model: typing.Type[BaseException],
        ...
        Args:
            ...
            model: Target error model. Must be inherited from `BaseException`
        ...
        Examples:
            ...
            the `relative_occurrence` True flag
                ...
                class WrongRoleName(BaseException):
